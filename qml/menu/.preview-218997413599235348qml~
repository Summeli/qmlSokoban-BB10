	...
	Flickable {
		...
		Text {
			...
			text: qsTr("<p>This is a Sokoban game. The purpose of the game "
			      ...
			      + "<p>Porting to BlacBerry 2012, Antti Pohjola, summeli@summeli.fi</p>"
			      + "<p>You can find the qmlSokoban source codes from my github repo http://github.com/Summeli</p>"
